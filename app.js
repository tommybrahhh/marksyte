const copy = {
  en: {
    ...
    offers: {
      eyebrow: "Specialist consulting projects",
      title: "Four projects. One clear commercial decision at a time",
      intro:
        "Each project is built around the decision your team needs to make now. We structure the evidence, compare the options and deliver a practical route forward",
  ...
  es: {
    ...
    offers: {
      eyebrow: "Proyectos de consultoría especializada",
      title: "Cuatro proyectos. Una decisión comercial clara cada vez",
      intro:
        "Cada proyecto se construye alrededor de la decisión que tu equipo necesita tomar ahora. Ordenamos la evidencia, comparamos las opciones y entregamos una ruta práctica para avanzar",
